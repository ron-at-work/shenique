...
const products = [
  {
    id: 1,
    name: "Maroon Embroidered Straight Kurti",
    price: 1299,
    originalPrice: 1899,
  ...
  {
    id: 2,
    name: "Beige Floral Print A-Line Kurti",
    price: 999,
    originalPrice: 1499,
  ...
  {
    id: 3,
    name: "Blue Cotton Straight Kurti",
    price: 1199,
    originalPrice: 1799,
  ...
  {
    id: 4,
    name: "Pink Georgette Anarkali Kurti",
    price: 1599,
    originalPrice: 2299,
  ...
  {
    id: 8,
    name: "Navy Blue Office Wear Kurti",
    price: 1099,
    originalPrice: 1599,
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
              <p className="text-gray-600">
                <span className="font-semibold text-gray-900">{products.length * 92}</span> products
              </p>
